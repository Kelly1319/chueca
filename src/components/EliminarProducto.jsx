...
function EliminarProducto() {
  ...
  const eliminarProducto = async () => {
    ...
    try {
      ...
      fetch(`https://68d482f6214be68f8c696b82.mockapi.io/api/productos/${producto.id}`, {
        method: 'DELETE',
      });
  ...
  return (
    <div style={{ maxWidth: '500px', margin: '40px auto', padding: '20px', textAlign: 'center' }}>
      <h2 style={{ color: '#080808ff', marginBottom: '20px' }}>Eliminar Producto</h2>
      ...
      <div style={{
        ...
        <h3 style={{ color: '#080808ff' }}>¿Estás seguro de que deseas eliminar este producto?</h3>
      ...
      <div style={{ display: 'flex', gap: '15px', justifyContent: 'center' }}>
        <button
          ...
          style={{
            padding: '12px 24px',
            backgroundColor: cargando ? '#ccc' : '#080808ff',
            color: 'white',
            border: 'none',
            borderRadius: '4px',
